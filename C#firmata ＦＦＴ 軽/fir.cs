...
namespace Firmata.NET
{
    ...
    class Arduino
    {
        ...
        public void ArduinoOpen (string serialPortName, Int32 baudRate, bool autoStart, int delay)
        {
        ...
        internal void ArduinoOpen(string p1, int p2)
        {
            _serialPort = new SerialPort(p1,p2);
